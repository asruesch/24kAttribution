...
stat = arcpy.GetParameterAsText(8)
rasterType = arcpy.GetParameterAsText(9)

cmdString = rDir + '\\Rscript.exe" ' + zoneScript + " " + rasterFolder + " " + zones + " " + outputFolder + " " + tempRDir + " " + runID + " " + zoneType + " " + stat + " " + rasterType
