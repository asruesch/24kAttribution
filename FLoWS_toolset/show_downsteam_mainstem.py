# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ~~~~~~~~~~~~~~~~~  Show Downstream selection based on selected features  ~~~~~~~~~~~~~~
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
if __name__ == "__main__":
    ...
    if tb: # IF ReltableName exists then
        ...
        gp.AddMessage(" ")
        gp.AddMessage("Finding Downstream Main Stem....")
        gp.AddMessage(" ")
        for rid in ridList:
            rs = win32com.client.Dispatch(r'ADODB.Recordset')
            querystring = "SELECT relationships.fromfeat, relationships.tofeat FROM relationships WHERE (((relationships.fromfeat)=" + str(rid) + "));"
